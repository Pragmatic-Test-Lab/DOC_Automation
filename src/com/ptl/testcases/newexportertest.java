...
public class newexportertest extends TestBase {
	@BeforeSuite
	public void init(){
		initConfiguration();
	...
	public void RegNewExpTest(Hashtable<String,String> data){
		...
		LoginCredentialsPage logcred = expRegPage.doRegisterNewExporter(data.get("Company Name"), data.get("Business RegNo"), data.get("Official Address"), 
