...
public class doc3mandatoryerrormsg extends TestBase {
	@BeforeSuite
	public void init() {
		initConfiguration();
		APPLICATION_LOGS
	...
	public void RegNewExpTest(Hashtable<String,String> data){
		...
		expRegPage.doRegisterNewExporter2(data.get("Company Name"), data.get("Business RegNo"), data.get("Official Address"), 
