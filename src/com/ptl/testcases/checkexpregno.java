...
public class checkexpregno extends TestBase{
	@BeforeSuite
	public void init() {
		initConfiguration();
		APPLICATION_LOGS
	...
	public void CheckRegister(Hashtable<String, String> data) {
		...
		LoginCredentialsPage logcred = expRegPage.doRegisterNewExporter(
				data.get("Company Name"), data.get("Business RegNo"),
				data.get("Official Address"), data.get("Tel"), data.get("Fax"),
				data.get("Contact Email"), data.get("Contact Person"),
				data.get("COO Name"), data.get("COO Mobile"),
				data.get("COO Email"));
